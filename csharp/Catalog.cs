    ...
    public partial class Catalog : Form
    {
        ...
        private void buttonAdaugaNota_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                AvailableGradeForm mesaj = new AvailableGradeForm();
                this.Hide();
                mesaj.ShowDialog();
                this.Show();
                return;
            ...
            if(numeMaterie!=null&&numeMaterie!="")
            {
                ...
                AddGradeForm f = new AddGradeForm();
                this.Hide();
                f.ShowDialog();
                this.Show();
            ...
            {
                PickSubjectForm mesajul= new PickSubjectForm();
                this.Hide();
                mesajul.ShowDialog();
                this.Show();
        ...
        private void buttonAdaugaTeza_Click(object sender, EventArgs e)
        {
            ...
            if(numeMaterie==null||numeMaterie=="")
            {
                PickSubjectForm mesajul1 = new PickSubjectForm();
                this.Hide();
                mesajul1.ShowDialog();
                this.Show();
            }
            if (numeMaterie.Equals("Matematica"))
            {
                ...
                if (teza1 != 0)
                {
                    ...
                    AddOnlyOnceForm mesaj1 = new AddOnlyOnceForm();
                    this.Hide();
                    mesaj1.ShowDialog();
                    this.Show();
                    return;
                ...
                AddGradeForm mesaj= new AddGradeForm();
                this.Hide();
                mesaj.ShowDialog();
                this.Show();
            ...
            else if (numeMaterie.Equals("Chimie"))
            {
                ...
                {   //Poti da teza doar la o singura a patra materie!
                    IntroduceOneGradeForm mesaj = new IntroduceOneGradeForm();
                    this.Hide();
                    mesaj.ShowDialog();
                    this.Show();
        ...
        private void buttonAdaugaAbsenta_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("idelev",LoginForm.id);
